...
public class UserServiceTest {
    ...
    public void before() {
        ...
        userService = new UserService(userRepositoryMock, skillRepositoryMock, userSkillRepositoryMock, userJobRepositoryMock);
    }
    ...
    public void getUserByEmail() {
        when(userRepositoryMock.findByEmail(any())).thenReturn(new User());
    ...
    public void getUserBySessionId() {
        when(userRepositoryMock.findBySessionId(any())).thenReturn(new User());
